        ...
        tasks: [
          {
            id: 1,
            title: "Design UI",
            description: "Create user interface mockups and layouts",
            status: "todo",
          },
          {
            id: 2,
            title: "Setup Backend",
            description: "Initialize backend server and APIs",
            status: "inprogress",
          },
          {
            id: 3,
          ...
          },
          {
            ...
            description: "Document features and usage",
            status: "todo",
          },
          {
            id: 5,
            title: "Create Wireframes",
            description: "Design wireframes for main screens",
            status: "todo",
          },
          {
            id: 6,
            title: "Fix Bugs",
            description: "Resolve reported bugs and issues",
            status: "inprogress",
          },
          {
            id: 7,
            title: "Test Features",
            description: "Test new and existing features",
            status: "done",
          },
          {
            id: 8,
          ...
          },
          {
            ...
            description: "Refactor React components for reusability",
            status: "todo",
          },
          {
            id: 13,
          ...
          },
          {
            ...
            description: "Set up code linting tools",
            status: "done",
          },
          {
            id: 15,
          ...
          },
          {
            ...
            description: "Collect feedback from users and stakeholders",
            status: "done",
          },
          {
            id: 21,
            title: "Update Roadmap",
            description: "Revise the project roadmap and milestones",
            status: "todo",
          },
          {
            id: 22,
            title: "Setup Analytics",
            description: "Integrate analytics tools for tracking",
            status: "inprogress",
          },
        ],
